...
class DataLoader:
    def __init__(self, dataset_dir, batch_size, n_workers=8, n_epochs=1):
...
"""
1. dataset_dir
2. list of trajectory paths

3. sample trajectories
4. sample target frames
5. sample K context frames using monte-carlo overlap
6. convert to relative pose

7. yield batch of B (target_frame, context_frames, relative_context_poses, action) samples
"""